...
const Article = ({ content, onEdit }: Props) => (
    <div className="bg-white-0 border border-stroke-soft-200 rounded-xl p-4 pb-0 shadow-xl overflow-hidden max-md:p-0">
        <div className="flex items-center gap-2 mb-5 max-md:mb-0 max-md:p-3">
            <div className="flex items-center gap-2 mr-auto text-[1rem] font-medium text-strong-950">
                <Icon className="fill-strong-950" name="document-check" />
                Document
            </div>
            <Button
                className="max-md:shrink-0 max-md:w-10 max-md:h-10 max-md:p-0 max-md:gap-0 max-md:text-0 border border-stroke-soft-200 hover:bg-weak-50"
                isStroke
            >
                <svg
                ...
                <span className="text-strong-950">Download Article</span>
            </Button>
            <Button
        ...
        <div className="content max-h-96 bg-white-0 text-strong-950 border border-stroke-soft-200 px-18 py-16 rounded-xl shadow-xl overflow-y-auto scrollbar-none max-2xl:p-12 max-xl:p-8 max-md:px-3 max-md:py-4">
            {content}
        </div>
    </div>
);
