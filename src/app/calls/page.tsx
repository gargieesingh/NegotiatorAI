      ...
      <div className="chat-wrapper">
        <div className="p-8 grow overflow-auto scrollbar-none space-y-6">
          ...
          {calls ? (
            <>
              <section className="rounded-2xl border border-stroke-soft-200 bg-white-0 p-6 shadow-2xs">
                <div className="flex items-start gap-3">
                  ...
                  <div>
                    <h2 className="font-semibold text-strong-950 font-inter">Live demo participant setup</h2>
                    <p className="mt-1 text-sm text-sub-600">
                      Enter only consented human role-player numbers. The agent thanks and ends each call after collecting a quote.
                    </p>
                  </div>
                </div>
                ...
                <div className="mt-6 grid gap-4 md:grid-cols-3">
                  {calls.map((call) => (
                    <div key={call.id} className="rounded-xl border border-stroke-soft-200 bg-weak-50 p-4">
                      ...
                      <p className="mt-1 text-[10px] font-semibold uppercase tracking-wider text-sub-600">
                ...
                <button
                  ...
                  className="mt-6 inline-flex items-center gap-2 rounded-xl bg-blue-600 hover:bg-blue-700 px-5 py-3 text-sm font-semibold text-white-0 transition-colors disabled:opacity-60 cursor-pointer shadow-xs"
                >
                  <PhoneCall size={16} />
            ...
            <div className="flex items-center gap-3 text-sub-600 py-12">
