...
import { demoVendorRoles, jobSpecStorageKey, quotesStorageKey } from '@/lib/config';
import type { ConversationState, DemoVendorParticipant, JobSpec, Quote } from '@/lib/types';

function createCall(jobSpec: JobSpec, role: typeof demoVendorRoles[number]): ConversationState {
