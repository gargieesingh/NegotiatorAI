          ...
          <div className="p-8 grow overflow-auto scrollbar-none">
            <section className="rounded-2xl border border-amber-200 bg-amber-50/40 p-8 shadow-[0_0_1.25rem_0_rgba(0,0,0,0.03)]">
              <div className="flex items-center gap-3 text-amber-700">
                <FileWarning size={24} />
                <h1 className="text-2xl font-bold text-strong-950 font-inter">Your evidence-backed quote report</h1>
              </div>
    ...
    <Layout>
      <div className="chat-wrapper">
        <div className="p-8 grow overflow-auto scrollbar-none space-y-8">
          ...
          {/* Header */}
          <div className="flex flex-wrap items-center justify-between gap-4 pb-6 border-b border-stroke-soft-200">
            <div>
            ...
            <div className="flex items-center gap-2.5">
              <button
                ...
                className="inline-flex items-center gap-2 rounded-xl border border-stroke-soft-200 bg-white-0 px-4 py-2.5 text-xs font-semibold text-strong-950 hover:bg-weak-50 transition-colors cursor-pointer shadow-2xs"
              >
              ...
              <button
                type="button"
                onClick={() => router.push('/')}
                className="inline-flex items-center gap-2 rounded-xl bg-blue-600 hover:bg-blue-700 px-4 py-2.5 text-xs font-semibold text-white-0 transition-colors cursor-pointer shadow-xs"
              >
                <RotateCcw className="size-3.5" /> Start New Search
              </button>
            </div>
          </div>
          ...
          <div className="grid grid-cols-1 md:grid-cols-3 gap-6">
            ...
            <div className="rounded-2xl border border-green-200 bg-green-50/40 p-6 shadow-2xs flex flex-col justify-between">
              <div>
                ...
                <h2 className="text-xl font-bold text-strong-950 mt-1 font-inter">{recommendedVendor.company_name}</h2>
            ...
            <div className="rounded-2xl border border-stroke-soft-200 bg-white-0 p-6 shadow-2xs flex flex-col justify-between">
              <div>
                <span className="text-xs font-bold uppercase tracking-wider text-sub-600">Total Savings Achieved</span>
            ...
            <div className="rounded-2xl border border-stroke-soft-200 bg-white-0 p-6 shadow-2xs flex flex-col justify-between">
              <div>
                <span className="text-xs font-bold uppercase tracking-wider text-sub-600">Verification & Scope</span>
          ...
          <section className="rounded-2xl border border-stroke-soft-200 bg-white-0 p-6 shadow-2xs">
            <div className="flex items-center justify-between pb-4 border-b border-stroke-soft-200 mb-5">
              <div>
                <h2 className="text-base font-bold text-strong-950 font-inter">Executive Line-Item Comparison Viewport</h2>
                <p className="text-xs text-sub-600 mt-0.5">All prices extracted directly from audio transcripts without manual edits</p>
              </div>
              ...
              <table className="w-full text-left text-sm">
                ...
                <tbody className="divide-y divide-stroke-soft-200 text-strong-950">
                  {quotes.map((q) => {
                    ...
                    return (
                      <tr key={q.quote_id} className={isRec ? 'bg-green-50/30' : 'hover:bg-weak-50/50 transition-colors'}>
                        ...
                        <td className="py-4 px-4 text-xs font-semibold text-sub-600">
                          {q.quote.binding ? <span className="text-green-700 font-medium">Binding ({q.quote.valid_until})</span> : <span className="text-amber-700 font-medium">Non-binding</span>}
                        </td>
                        <td className="py-4 px-4">
                          {q.price_changed_during_call ? (
                            <span className="inline-block rounded-full bg-green-100 px-2.5 py-1 text-xs font-bold text-green-800">
                              Negotiated Down
                            </span>
                          ) : (
                            <span className="inline-block rounded-full bg-weak-50 border border-stroke-soft-200 px-2.5 py-1 text-xs text-sub-600 font-medium">
                              Standard Rate
                            </span>
                          )}
                        </td>
          ...
          <section className="rounded-2xl border border-stroke-soft-200 bg-white-0 p-6 shadow-2xs">
            <h2 className="text-base font-bold text-strong-950 mb-4 flex items-center gap-2 font-inter">
            ...
            <div className="grid grid-cols-1 md:grid-cols-2 gap-6 text-sm">
              <div className="rounded-2xl border border-stroke-soft-200 bg-weak-50 p-4">
                <h3 className="font-bold text-strong-950 text-xs uppercase tracking-wider mb-2">Competing Leverage Cited</h3>
              ...
              <div className="rounded-2xl border border-stroke-soft-200 bg-weak-50 p-4">
                <h3 className="font-bold text-strong-950 text-xs uppercase tracking-wider mb-2">Final Outcome & Savings</h3>
                <p className="text-sub-600 text-xs leading-relaxed">
