        ...
        <div className="p-8 grow overflow-auto scrollbar-none space-y-6">
          ...
          <section className="rounded-2xl border border-stroke-soft-200 bg-white-0 p-6 shadow-2xs">
            <div className="flex flex-wrap items-center justify-between gap-4">
              <div>
                <h2 className="font-semibold text-strong-950 font-inter">Find up to 10 businesses</h2>
              ...
              <button
                ...
                className="inline-flex items-center gap-2 rounded-xl bg-blue-600 hover:bg-blue-700 px-4 py-2.5 text-xs font-semibold text-white-0 transition-colors disabled:opacity-60 cursor-pointer shadow-xs"
              >
            ...
            {error && (
              <div className="mt-5 rounded-xl border border-red-200 bg-red-50 p-4 text-sm text-red-700">
                ...
                <p className="mt-2 text-sub-600">
                  Add `GOOGLE_MAPS_API_KEY` to your local environment, enable Places API (New), then try again.
                </p>
              </div>
            )}
          </section>
            ...
            <>
              <div className="flex items-center justify-between gap-4">
                <div>
                  ...
                  <p className="mt-1 text-xs text-sub-600">
                    Select three consented role-players for the live demo. Discovery evidence remains visible.
                  </p>
                </div>
                <p className="text-xs font-bold text-blue-600 bg-blue-50 border border-blue-200 rounded-full px-3 py-1">{selected.length}/3 selected</p>
              </div>
                    ...
                    <article
                      ...
                      className={`rounded-2xl border p-5 shadow-2xs transition-all ${
                        isSelected
                          ...
                          : 'border-stroke-soft-200 bg-white-0 hover:border-stroke-soft-300'
                      }`}
                    >
                      <div className="flex items-start justify-between gap-3">
                        <div>
                          <div className="flex items-center gap-2">
                            ...
                            <h2 className="font-semibold text-strong-950 font-inter">{vendor.name}</h2>
                          </div>
                      ...
                      <div className="mt-5 flex flex-wrap gap-x-5 gap-y-2 border-t border-stroke-soft-200 pt-4 text-xs">
              ...
              <section className="flex flex-wrap items-center justify-between gap-4 rounded-2xl border border-stroke-soft-200 bg-white-0 p-6 shadow-2xs">
                <div className="flex gap-3">
                  ...
                  <p className="max-w-xl text-xs leading-relaxed text-sub-600">
                    For the demo, replace the selected business numbers with consented role-player numbers before batch calling.
                  </p>
                </div>
                <button
                  type="button"
                  onClick={continueToCalls}
                  className="rounded-xl bg-green-600 hover:bg-green-700 px-5 py-2.5 text-xs font-semibold text-white-0 transition-colors cursor-pointer shadow-xs"
                >
